...
#ifndef __PYX_HAVE__Yanshee
#define __PYX_HAVE__Yanshee
...
#ifndef __PYX_HAVE_API__Yanshee
...
__PYX_EXTERN_C PyObject *get_ip_address(PyObject *, int __pyx_skip_dispatch);
__PYX_EXTERN_C void yan_api_init(PyObject *, int __pyx_skip_dispatch);
__PYX_EXTERN_C PyObject *get_robot_battery_info(int __pyx_skip_dispatch);
__PYX_EXTERN_C int get_robot_battery_value(int __pyx_skip_dispatch);
...
__PYX_EXTERN_C int sync_set_led(PyObject *, PyObject *, PyObject *, int __pyx_skip_dispatch);
...
__PYX_EXTERN_C int get_robot_volume_value(int __pyx_skip_dispatch);
__PYX_EXTERN_C PyObject *get_robot_volume(int __pyx_skip_dispatch);
__PYX_EXTERN_C int set_robot_volume_value(PyObject *, int __pyx_skip_dispatch);
...
__PYX_EXTERN_C int get_servo_angle_value(PyObject *, int __pyx_skip_dispatch);
...
#endif /* !__PYX_HAVE_API__Yanshee */

/* WARNING: the interface of the module init function changed in CPython 3.5. */
/* It now returns a PyModuleDef instance instead of a PyModule instance. */

#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initYanshee(void);
#else
/* WARNING: Use PyImport_AppendInittab("Yanshee", PyInit_Yanshee) instead of calling PyInit_Yanshee directly from Python 3.5 */
PyMODINIT_FUNC PyInit_Yanshee(void);

#if PY_VERSION_HEX >= 0x03050000 && (defined(__GNUC__) || defined(__clang__) || defined(_MSC_VER) || (defined(__cplusplus) && __cplusplus >= 201402L))
#if defined(__cplusplus) && __cplusplus >= 201402L
[[deprecated("Use PyImport_AppendInittab(\"Yanshee\", PyInit_Yanshee) instead of calling PyInit_Yanshee directly.")]] inline
#elif defined(__GNUC__) || defined(__clang__)
__attribute__ ((__deprecated__("Use PyImport_AppendInittab(\"Yanshee\", PyInit_Yanshee) instead of calling PyInit_Yanshee directly."), __unused__)) __inline__
#elif defined(_MSC_VER)
__declspec(deprecated("Use PyImport_AppendInittab(\"Yanshee\", PyInit_Yanshee) instead of calling PyInit_Yanshee directly.")) __inline
#endif
static PyObject* __PYX_WARN_IF_PyInit_Yanshee_INIT_CALLED(PyObject* res) {
  return res;
}
#define PyInit_Yanshee_auto() __PYX_WARN_IF_PyInit_Yanshee_INIT_CALLED(PyInit_Yanshee())
#endif
#endif

#endif /* !__PYX_HAVE__Yanshee */
